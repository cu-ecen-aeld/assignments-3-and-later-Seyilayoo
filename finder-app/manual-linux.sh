...
FINDER_APP_DIR=$(realpath $(dirname $0))/../assignments-3-and-later-Seyilayoo
ARCH=arm64
...
# Copy the writer application
cp writer "${OUTDIR}/rootfs/home/"


# TODO: Copy the finder related scripts and executables to the /home directory
# on the target rootfs
rsync -avz "$FINDER_APP_DIR/" "${OUTDIR}/rootfs/home/"
...
find "${OUTDIR}/rootfs" -print | cpio -H newc -o | gzip -c > "${OUTDIR}/initramfs.cpio.gz"
